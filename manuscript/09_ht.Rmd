...
```{r title="Example of using the *t* test in R.", echo=TRUE}
...
```{r title="Reformatting the data.", echo=TRUE}
...
```{r title="Unequal variance T test comparing diets 1 and 4.", echo=TRUE}
