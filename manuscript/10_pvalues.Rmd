...
```{r title="P-value calculation in R.", echo=TRUE}
...
```{r title="Example of a Binomial P-value calculation in R.", echo=TRUE}
...
```{r title="Poisson P-value calculation.", echo=TRUE}
