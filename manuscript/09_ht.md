...
{$$}H_1: \mu < \mu_0{/$$}, {$$}H_2: \mu \neq \mu_0{/$$},
{$$}H_3: \mu > \mu_0{/$$}. Test statistic

{$$}TS = \frac{\bar{X} - \mu_0}{S / \sqrt{n}}{/$$}

Rejects the null hypothesis when
{$$}TS \leq Z_{\alpha} = -Z_{1 - \alpha}{/$$},
{$$}|TS| \geq Z_{1 - \alpha / 2}{/$$} and {$$}TS \geq Z_{1 - \alpha}{/$$},
respectively.

### Notes on the general rules
...
In our exsample, we want to test the alternative {$$}H_a : \mu \neq 30{/$$}.
...
{$$}
\frac{\mbox{Estimate} - \mbox{Hypothesized Value}}{\mbox{Standard Erro}}
{/$$}
