...
```{r , echo=TRUE, fig.cap="Cumulative average from  standard normal simulations.", label = "normalLLN"}
n <- 10000
...
```{r , echo=TRUE, fig.cap="Cumulative proportion of heads from a sequence of coin flips.", label = "coinLLN"}
