...
useful component of the book is [a series of YouTube videos](https://www.youtube.com/watch?v=WkOinijQmPU&list=PLpl-gQkQivXiBmGyzLrUjzsblmQsLtkzJ) that comprise the
Coursera class.

The book is intended to be a low cost introduction to the important field of
statistical inference. The intended audience is students who are numerically
and computationally literate, and who would like to put those skills to use in
...
polymath who invented many key concepts of statistics. The quincunx
