...
```{r , echo=FALSE, fig.cap="Distributions with increasing variance", label = "normalVariances2", fig.height=4}
library(ggplot2)
...
```{r title="Plotting the binomial variance", echo=TRUE, fig.cap="Plot of the binomial variance", label = "binomialVariance"}
...
```{r , echo=FALSE, fig.cap="Simulation of variances of samples of standard normals", label = "normalVariances", fig.height=5}
library(ggplot2)
nosim <- 10000; 
dat <- data.frame(
...
```{r , echo=FALSE, fig.cap="Simulated distributions of variances of dice", label = "dieVariances", fig.height=4}
dat <- data.frame(
...
```{r title="Simulating means of random normals", echo=TRUE}
nosim <- 1000
n <- 10
...
```{r title="Simulating means of uniforms", echo=TRUE}
nosim <- 1000
n <- 10
...
```{r title="Simulating means of Poisson variates", echo=TRUE}
nosim <- 1000
n <- 10
...
```{r title="Simulating means of coin flips", echo=TRUE}
nosim <- 1000
n <- 10
...
```{r title="Loading the data", echo=TRUE}
...
```{r , echo=FALSE, fig.cap="Histogram of the sons' heights", label = "fatherSon"}
