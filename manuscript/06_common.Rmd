...
```{r , echo=FALSE, fig.cap="Standard normal reference lines.", label = "normalReference"}
...
```{r title="Finding a normal quantile", echo=TRUE}
...
```{r title="Finding a Poisson quantile", echo=TRUE}
...
```{r title="Aproximating a binomial quantile", echo=TRUE}
