...
![Uniform Density](LeanPub/images/uniform-1.png) 
...
![Plot of the binomial variance](LeanPub/images/binomialVariance-1.png) 
...
![Standard normal reference lines.](LeanPub/images/normalReference-1.png) 
...
![Cumulative average from standard normal simulations.](LeanPub/images/normalLLN-1.png) 
...
![Cumulative proportion of heads from a sequence of coin flips.](LeanPub/images/coinLLN-1.png) 
...
![Coverage of Poisson intervals for various values of lambda and t=1000](LeanPub/images/poissonCoverage2-1.png) 
...
\vspace{1pc}\verb;Code for investigating *t* and Z densities.:;
...
\vspace{1pc}\verb;Code for investigating the upper quantiles of the *t* and Z densities.:;
...
\vspace{1pc}\verb;Loading Galton's data.:;
...
![A plot of the pairs of observations from Galton's sleep data.](LeanPub/images/galtonSleep-1.png) 
...
\vspace{1pc}\verb;*t* interval from baseline to follow up.:;
...
\vspace{1pc}\verb;Galton's data treated as grouped and independent.:;
...
![Chickweight data over time.](LeanPub/images/chickweight-1.png) 


Here's a plot only of the weight gain for the diets.

![Violin plots of chickweight data by weight gain (final minus baseline) by diet.](LeanPub/images/chickweightgroups-1.png) 
...
\vspace{1pc}\verb;Code for t interval of the chickWeight data:;
...
\vspace{1pc}\verb;Example of using the *t* test in R.:;
...
\vspace{1pc}\verb;Reformatting the data.:;
...
\vspace{1pc}\verb;Unequal variance T test comparing diets 1 and 4.:;
...
\vspace{1pc}\verb;P-value calculation in R.:;
...
\vspace{1pc}\verb;Example of a Binomial P-value calculation in R.:;
...
\vspace{1pc}\verb;Poisson P-value calculation.:;
...
\vspace{1pc}\verb;Power calculation for the sleep example in R:;
...
![Plot of power as $\mu_a$ varies.](LeanPub/images/powerCurve-1.png) 
...
\vspace{1pc}\verb;Code for investigating power.:;
...
\vspace{1pc}\verb;Example of using 'power.t.test' in R.:;
...
![Image of true die roll distribution (left) and simulation of averages of 50 die rolls](LeanPub/images/bootstrapping1-1.png) 
...
![Image of empirical die roll distribution (left) and simulates of averages of 50 die rolls from this distribution](LeanPub/images/bootstrapping2-1.png) 
...
\vspace{1pc}\verb;Bootstrapping example:;
...
![Bootstrapping example for the median of sons' heights from Galton's](LeanPub/images/bootstrapping3-1.png) 
...
![A plot of the histrogram of the resamples](LeanPub/images/bootstrapping4-1.png) 
...
![Comparison of insect spray.](LeanPub/images/bootstrapping5-1.png) 
...
\vspace{1pc}\verb;Permutation distribution for the insect sprays dataset.:;
...
![Permutation distribution from the insectsprays dataset](LeanPub/images/bootstrapping6-1.png) 
